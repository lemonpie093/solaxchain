$(document).ready(function(){
	...
	if( $('#countdown').length > 0 ) {
		...
		var layout = '<div class="countdown-section"><div class="countdown-amount">{dn}D</div><span class="sep">{sep}</span></div>'
				+'<div class="countdown-section"><div class="countdown-amount">{hnn}H</div><span class="sep">{sep}</span></div>'
				+'<div class="countdown-section"><div class="countdown-amount">{mnn}M</div><span class="sep">{sep}</span></div>'
				+'<div class="countdown-section secs"><div class="countdown-amount">{snn}S</div></div>',
